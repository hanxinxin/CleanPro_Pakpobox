...
@interface EwashMyViewController ()<UITableViewDelegate,UITableViewDataSource,FBSDKSharingDelegate>
...
@implementation EwashMyViewController
...
//    }
    ...
    ///////////
//    NSString * strPhoen=[[NSUserDefaults standardUserDefaults] objectForKey:@"mobile"];
...
//    NSString * strPhoen=[[NSUserDefaults standardUserDefaults] objectForKey:@"phoneNumber"];
    NSString * mobile=[[NSUserDefaults standardUserDefaults] objectForKey:@"Token"];
