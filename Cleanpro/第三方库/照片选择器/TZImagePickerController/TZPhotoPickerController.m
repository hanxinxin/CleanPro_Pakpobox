...
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:self action:@selector(cancel1)];
    
    UIButton * Rbtn=[UIButton buttonWithType:UIButtonTypeCustom];
    [Rbtn setTitle:FGGetStringWithKeyFromTable(@"取消", @"Language") forState:UIControlStateNormal];
    [Rbtn addTarget:self action:@selector(cancel1:) forControlEvents:UIControlEventTouchUpInside];
