...
//    NSLog(@"缩进= %f",[self collectionInset]);
}
...
//    NSLog(@"A+===== %f,%f .B==== ,%f,%f",proposedContentOffset.x,proposedContentOffset.y,velocity.x,velocity.y);
    // 计算出最终显示的矩形框
    CGRect rect;
    rect.origin.y = 0;
    ...
    CGFloat minDelta = SCREEN_WIDTH-(43*2);//cell的宽度
...
//    return (self.collectionView.bounds.size.width - [self cellWidth])/4;
    return 0;
}
