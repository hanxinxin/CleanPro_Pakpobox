...
//        [_cancelButton setTitle:@"取消" forState:UIControlStateNormal];
        [_cancelButton setTitle:FGGetStringWithKeyFromTable(@"Cancel", @"Language") forState:UIControlStateNormal];
        [_cancelButton setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
        _cancelButton.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:13];
        _cancelButton.tag = 1;
...
//        [_originButton setTitle:@"还原" forState:UIControlStateNormal];
        [_originButton setTitle:FGGetStringWithKeyFromTable(@"Reduction", @"Language") forState:UIControlStateNormal];
        [_originButton setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
        _originButton.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:13];
        _originButton.tag = 2;
...
//        [_finishButton setTitle:@"完成" forState:UIControlStateNormal];
        [_finishButton setTitle:FGGetStringWithKeyFromTable(@"Complete", @"Language") forState:UIControlStateNormal];
        [_finishButton setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
        _finishButton.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:13];
        _finishButton.tag = 3;
