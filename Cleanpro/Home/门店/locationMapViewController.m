...
-(void)down_viewShow
{
    [UIView animateWithDuration:0.6/*动画持续时间*/animations:^{
        //执行的动画
        self.Down_view.frame =CGRectMake(0, (SCREEN_HEIGHT-120), SCREEN_WIDTH, 120);
...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id<MKAnnotation>)annotation
{
    ...
    else if ([annotation isKindOfClass:[AircraftAnnotation class]])
    {
        ...
        annotationView.image = [UIImage imageNamed:@"location_normal"];
...
//        NSLog(@"title===%ld",mac.tagg);
        ...
        self.mendianMiaoShu.text=MD_Mode.MDName;
    }
     [self down_viewShow];
}
